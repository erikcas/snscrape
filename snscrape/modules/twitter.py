...
_API_AUTHORIZATION_HEADER = os.environ.get("API_AUTHORIZATION_HEADER")
_API_COOKIE_HEADER = os.environ.get("API_COOKIE")
_API_CSRF_HEADER = os.environ.get("API_CSRF")
...
class _TwitterAPIScraper(snscrape.base.Scraper):
	def __init__(self, baseUrl, *, guestTokenManager = None, maxEmptyPages = 0, **kwargs):
		...
		self._apiHeaders = {
            ...
            'cookie': _API_COOKIE_HEADER,
            'x-csrf-token': _API_CSRF_HEADER,
